const esModules = ['quasar', 'quasar/lang', 'lodash-es', '@vuelidate'].join('|');

module.exports = {
  setupFiles: ['<rootDir>/test/jest/unit/mock-data/test-setup.js'],
  ...
  testMatch: [
    ...
    '<rootDir>/test/jest/unit/**/*.(spec|test).js',
